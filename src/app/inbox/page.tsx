...
const InboxPage = ({isOpen}:IInboxPage) => {
  ...
  const sent = [
    ...
    },
    {
      ...
      message:
        "The high current arc ignition tester may determine how well an electrical or electronic device, home appliance, or material can withstand an arc. The device functions by simulating electric leakage on the insulator, which might result in varying polarizations of live components or between live components and grounded (earthed) metal components. This tool may also evaluate the insulator’s arc resistance performance at the specified voltage.",
